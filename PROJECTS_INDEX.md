...
| `Daily_for_Barobogi/` | AI Study / Logs 블로그 | 진행 중 |
...
| `260623_1_study_all/` | Study Dashboard (Daily_for_Barobogi 통합 대기) | 2026-07-04 |
...
| 폴더 | 설명 | 비고 |
|------|------|------|
| `260620_2_Daily_for_barobogi/` | Daily_for_Barobogi 프로토타입 (6/20) | registry 비활성화됨 |
