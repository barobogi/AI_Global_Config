# pollinations_batch_ep02.py — Pollinations.ai로 EP02 씬 이미지 배치 생성 (1920x1080)
import sys, json, time, urllib.request, urllib.parse
from pathlib import Path

sys.stdout.reconfigure(encoding='utf-8', errors='replace')

SCRIPT_PATH = Path(r"D:\AI\63_youtube_creator\pipeline\scripts\main_ep02_full_script.json")
OUTPUT_DIR  = Path(r"D:\AI\63_youtube_creator\pipeline\images\ep02")
...
def main():
    ...
    total = len(scenes)
    print(f"Pollinations.ai 배치 시작 — 총 {total}개 (EP02 가로형)")
