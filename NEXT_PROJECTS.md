...
**최초 작성**: 2026-06-21  
**최종 업데이트**: 2026-07-01 (인프라 안정화 + AI_hub 구축 + n8n 재설치 진행 중)  
**상태**: 인프라 안정화 완료 / AI_hub v1.0 병렬 협업 첫 가동 / n8n 재설치 중
...
**다음 (RAM 설치 후):**
1. n8n 첫 실행 → localhost:5678 계정 생성  ← RAM 8GB 내일 도착 후 시작
2. 텔레그램 inbound → n8n 트리거 대체
3. AI_hub P3~P5 (tasks/context 운용, 코니_sync 흡수)
4. **[n8n setup 후]** 코니 실시간 동기화 — 파일 변경 시 n8n이 코니 세션에 재읽기 알림 전송
