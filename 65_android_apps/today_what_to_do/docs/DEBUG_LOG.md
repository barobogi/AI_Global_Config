...
- [2026-09-01 05:59] [Play Store User Review Bug] 사용자: 김철수 | 평점: 1점 | 내용: "지도 길찾기 클릭 시 특정 기종에서 화면 전환 오류가 생깁니다. 수정 요청해요."

- [2026-08-31 21:10] [Play Store User Review Bug] 사용자: 김철수 | 평점: 1점 | 내용: "지도 길찾기 클릭 시 특정 기종에서 화면 전환 오류가 생깁니다. 수정 요청해요."

- [2026-09-01 13:59] [Play Store User Review Bug] 사용자: 김철수 | 평점: 1점 | 내용: "지도 길찾기 클릭 시 특정 기종에서 화면 전환 오류가 생깁니다. 수정 요청해요."
