...
**영상 제목:** ClickUp Brain2: The AI That Replaces All Your Software
**URL:** https://youtu.be/AZXV1zzuFuQ
...
## S (Steps)
1. ~~yt-dlp로 자막 추출~~ **완료 — 만복이 이미 추출해둠**: `D:\AI\25_auto_pobbagi\transcripts\AZXV1zzuFuQ.txt` (YouTube IP 차단으로 안티 쪽 추출이 막힐 수 있어 만복이 미리 뽑아둠, 바로 2단계로 시작해도 됨)
