...
안티는 초보 개발자에게 세심하게 설명하는 친절한 멘토의 시각으로 아래 지시사항 및 기술 뽀개기 8단계 프로세스를 완수하십시오:
...
**영상 제목:** How I’d Make Money with [[Claude]] if my life depended on it
**URL:** https://youtu.be/vY0EzTP-7EA
...
## S (Steps)
1. ~~yt-dlp로 자막 추출~~ **완료 — 만복이 이미 추출해둠**: `D:\AI\25_auto_pobbagi\transcripts\vY0EzTP-7EA.txt` (YouTube IP 차단으로 안티 쪽 추출이 막힐 수 있어 만복이 미리 뽑아둠, 바로 2단계로 시작해도 됨)
